...
const pageConfig = {
  title: "Viralitate și Vânzări pe TikTok",
  subtitle: "TikTok nu mai este doar pentru dansuri. Este platforma #1 pentru descoperirea de produse noi. Dacă produsul tău e vizual, locul lui e aici.",
  icon: <FaTiktok size={40} className="text-black" />,
  benefits: [
    "Creative UGC (User Generated Content) care par native",
    "Costuri CPM mult mai mici față de Meta/Instagram",
    "Spark Ads pentru a amplifica postările organice",
    "Acces la audiențe tinere (Gen Z & Millennials)"
  ],
  description: `
    Pe TikTok, regula de aur este: "Don't Make Ads. Make TikToks."
    
    Agenția noastră colaborează cu creatori de conținut pentru a genera video-uri care nu arată a reclamă, ci a recomandare autentică. 
    
    Avem rețeta perfectă: Hook (primele 3 secunde) + Value + Call to Action. Această structură, combinată cu algoritmul TikTok, poate genera vânzări explozive peste noapte.
  `
};
      ...
      <section className="pt-32 pb-20 px-6 bg-gray-50 relative overflow-hidden">
         ...
         <div className="max-w-4xl mx-auto text-center relative z-10">
            ...
            <Link href="/contact?service=ads" className="inline-flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 text-white px-8 py-4 rounded-xl font-bold shadow-lg shadow-emerald-200 transition-all hover:-translate-y-1">
                Vreau o strategie TikTok <ArrowRight size={20}/>
            </Link>
         </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-tr from-emerald-100 to-gray-200 rounded-3xl transform rotate-3 scale-105 -z-10"></div>
                <div className="bg-white p-8 lg:p-12 rounded-3xl shadow-2xl border border-gray-100">
                    ...
                    <p className="text-gray-600 mb-6">
                        Creativele pe TikTok "obosesc" foarte repede. Trebuie să produci conținut nou săptămânal.
                    </p>
                    <div className="space-y-6">
                        <div className="flex items-center gap-4 p-4 bg-red-50 rounded-xl border border-red-100">
                             ...
                             <div>
                                ...
                                <p className="text-sm text-gray-500">Lipsă de idei, clipuri care nu prind, timp pierdut.</p>
                             </div>
                        </div>
                        <div className="flex items-center gap-4 p-4 bg-emerald-50 rounded-xl border border-emerald-100 shadow-sm">
                             ...
                             <div>
                                ...
                                <p className="text-sm text-gray-500">Scripturi virale, editare pro, testare rapidă.</p>
                             </div>
                        </div>
                    </div>
                    <div className="mt-8 pt-8 border-t border-gray-100 text-center">
                        <p className="text-sm text-gray-400 mb-4">Vrei să devii viral?</p>
