      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{card1_title}</h3>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{card2_title}</h3>
            ...
            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all group">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-3">{card3_title}</h3>
