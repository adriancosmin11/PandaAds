...
import { Check, X, Zap, Layout, ShoppingCart, ArrowRight, Server } from 'lucide-react';
  ...
  const plans = [
    {
      ...
      missing: ['CMS (Panou administrare)', 'Blog / Știri', 'Funcționalități E-commerce']
    },
    {
      id: 'business',
      name: 'BUSINESS',
      price: '1.990 €',
      badge: 'Best Value',
      description: 'Site complet pentru companii care vor să domine piața locală.',
    ...
    },
    {
      ...
      price: '3.990 €',
      badge: 'Headless Shop',
      description: 'Magazin online ultra-rapid. Experiență de cumpărare instantanee.',
    ...
    <section className="relative py-24 bg-white overflow-hidden" id="oferta">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl font-extrabold text-gray-900 mb-4"> Investiție transparentă</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Prețurile reflectă calitatea codului și a strategiei. Nu livrăm doar un site, 
            livrăm un activ digital care generează profit.
          </p>
        </div>
            ...
            >
              ...
              <div className="mb-6 border-b border-gray-100 pb-6">
                 ...
                 <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-gray-500 font-medium text-sm">/ proiect</span>
                 </div>
              ...
              <div className="flex-1 space-y-4 mb-8">
                ...
                {plan.missing.map((miss, i) => (
                  <div key={i} className="flex items-start gap-3 text-sm text-gray-400 opacity-70">
                    <X size={18} className="text-gray-300 shrink-0 mt-0.5"/>
                    <span className="leading-snug line-through decoration-gray-300">{miss}</span>
                  </div>
                ))}
              </div>
            ...
            <div className="bg-blue-50 border border-blue-100 rounded-2xl p-8 max-w-3xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
                <div className="text-left">
                    ...
                    <p className="text-gray-600 text-sm mt-2">
                        Ai nevoie de o platformă complexă, dashboard-uri sau o aplicație web personalizată?
                    </p>
                </div>
                <Link 
                    href="/contact"
