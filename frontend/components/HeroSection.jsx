...
const HeroSection = ({ data }) => {
  ...
  return (
    <section className="relative pt-24 pb-16 lg:pt-32 lg:pb-32 overflow-hidden bg-gray-50/50">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="space-y-8 text-center lg:text-left relative z-30">
          ...
          {/* BADGE (Animat) */}
          <div className="inline-flex items-center gap-2 bg-emerald-50 border border-emerald-100 px-4 py-1.5 rounded-full text-emerald-700 text-sm font-semibold mb-2 opacity-0 animate-fade-in-up">
          ...
          {/* TITLU (Animat cu delay) */}
          <h1 className="text-5xl lg:text-7xl font-extrabold text-gray-900 leading-[1.1] tracking-tight opacity-0 animate-fade-in-up delay-100">
          ...
          {/* SUBTITLU (Animat cu delay mai mare) */}
          <p className="text-lg text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed whitespace-pre-line opacity-0 animate-fade-in-up delay-200">
            {subtitle}
          </p>

          {/* BUTOANE (Animat cu delay și mai mare) */}
          <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2 opacity-0 animate-fade-in-up delay-300">
          ...
          {/* TRUST BADGES (Animat ultimul) */}
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-6 text-sm text-gray-500 pt-4 font-medium opacity-0 animate-fade-in-up delay-300">
        ...
        <div className="relative h-[500px] lg:h-[650px] flex items-center justify-center perspective-1000 hidden md:flex opacity-0 animate-fade-in-up delay-200">
           {/* Glow Effect */}
