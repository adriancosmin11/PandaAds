      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8 text-lg font-medium text-gray-600">
            ...
            <Link href="/#servicii" className="hover:text-emerald-600 transition-colors">
              Servicii
            </Link>
            <Link href="/#studii" className="hover:text-emerald-600 transition-colors">
              Studii de caz
            </Link>
            <Link href="/#preturi" className="hover:text-emerald-600 transition-colors">
              Prețuri
            </Link>
